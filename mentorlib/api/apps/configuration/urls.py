...
from mentorlib.api.apps.configuration.views import DepartmentView, SemesterView, ResourceView, StudyYearView, AllDepartmentsView, AllResourcesView, AllSemestersView, AllStudyYearsView
